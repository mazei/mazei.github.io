...
![ros_package_path](./ros_package_path.png)  
...
![catkin_create_pkg](./catkin_create_pkg.png)
...
catkin_make    
```  
![catkin_make](./catkin_make_1.png)
![catkin_make](./catkin_make_2.png)

 
2 *devel*

![catkin_make](./catkin_make_devel.png)


##2.5 package dependencies
###2.5.1 First-order dependencies
![rospack_depends1](./rospack_depends1.png)

These dependencies for a package are stored in the **package.xml file: 
![package_xml](./package_xml.png)

###2.5.2 Idirect dependencies
![rospack_depends](./rospack_depends.png)
...
##4.5 Using rosnode
![rosnode_list_info](./rosnode_list_info.png)
...
![rosrun_turtlesim](./rosrun_turtlesim.png)

![rosrun_turtlesim_named](./rosrun_turtlesim_named.png)

![rosrun_turtlesim_green](./rosrun_turtlesim_green.png)

![rosrun_turtlesim_named_nodes](./rosrun_turtlesim_named_nodes.png)
...
![turtlesim_teleop_key](./turtlesim_teleop_key.png)

![turtlesim_move](./turtlesim_move.png)
...
![rqtgraph_error](./rqtgraph_error.png)
...
![rqtgrapth_error](./rqtgraph_error_2.png)
...
![rqtgraph_with_comments](./rqtgraph_with_comments.png)

###5.2.2 Introducing rostopic

The *rostopic* tool allows you to get information about ROS **topics**.

![rostopic_h](./rostopic_h.png)
...
![rostopic_echo](./rostopic_echo.png)    

I have pressed the right button and the up button.

![rostopic_new_rqt_graph](./rostopic_new_rqt_graph.png)
...
![rostopic_list_h](./rostopic_list_h.png)

![rostopic_list_v](./rostopic_list_v.png)
...
![rosmsg_geometry](./rosmsg_geometry.png)
...
![rostopic_pub_msg](./rostopic_pub_msg.png)

![rostopic_pub_msg_moving](./rostopic_pub_msg_moving.png)

![rostopic_run](./rostopic_run.png)

![rostopic_run_turtle](./rostopic_run_turtle.png)

![rostopic_run_turtle_rqt](./rostopic_run_turtle_rqt.png)
...
![rostopic_rqt_plot](./rostopic_rqt_plot.png)
...
![rosservice_h](./rosservice_h.png)

###6.2.1 rosservice list

![rosservice_list](./rosservice_list.png)
...
![rosservice_type_clear](./rosservice_type_clear.png)
...
````
![rosservice_call_clear_1](./rosservice_call_clear_1.png)

![rosservice_call_clear_2](./rosservice_call_clear_2.png)
...
![rosservice_spawn](./rosservice_spawn.png)

![rosservice_two_turtles](./rosservice_two_turtles.png)
...
![rosparam_list](./rosparam_list.png)
...
![rosparam_r_150](./rosparam_r_150.png)

![rosparam_get](./rosparam_get.png)
...
````
![rosparam_dump](./rosparam_dump.png)
...
![rqt_console_turtles](./rqt_console_turtles.png)

![rqt_logger_level](./rqt_logger_level.png)

![rqt_console](./rqt_console.png)
...
![ros_launch_mimic](./ros_launch_mimic.png) 

![ros_launch_mimic_graph](./ros_launch_mimic_graph.png)
...
![msg_creating](./msg_creating.png)

![msg_package_setting](./msg_package_setting.png)
 
 CMakeLists.txt:
![msg_cmake_list_1](./msg_cmake_list_1.png)

![msg_cmake_list_2](./msg_cmake_list_2.png)
...
![srv_creating](./srv_creating.png)


CMakeLists:    

![srv_creating_cmake_lists](./srv_creating_cmake_lists.png)
...
![srv_c_header](./srv_c_header.png)

The Python script:
![srv_py_header](./srv_py_header.png)


##9.5 Getting Help

![ros_help](./ros_help.png)
...
![cpp_cmake_lists](./cpp_cmake_lists.png)
...
![cpp_executable](./cpp_executable.png)
...
![run_talker](./run_talker.png)


##11.2 Running the Subscriber

![run_listener](./run_listener.png)

#12. Writing a Simple Service and Client(C++)

##12.1 Writing a Service Node

![service_add_two_ints](./service_add_two_ints.png)

##12.2 Writing a Client Node

![service_client](./service_client.png)

##12.3 Building Nodes 

CMakeLists:

![service_cmake_lists](./service_cmake_lists.png)

````
$ catkin_make
````

![service_make](./service_make.png)
